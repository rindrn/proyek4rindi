...
import com.example.proyek41.ui.components.CartItem
...
fun CartContent(
    ...
    val shareMessage = stringResource(
        ...
        formatArgs = arrayOf(state.orderReward.count(), state.totalRequiredPoint)
    )
    Column(
        ...
        OrderButton(
            text = stringResource(id = R.string.total_order, formatArgs = arrayOf(state.totalRequiredPoint)),
